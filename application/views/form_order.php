												    	...
												    	<table class="table table-striped">
											    			...
											    			<tbody>
											    				<tr ng-repeat="x in menuDetail track by $index">
											    					...
											    					<td><a ng-click="removeItem($index,(x[2]*x[3])-x[4])" style="cursor:pointer;">Remove</a> | <a style="cursor:pointer;" data-toggle="modal" data-target="#myModal" ng-click="getRowIndex($index)">Comment</a></td>							    	
											    				</tr>
											    				<tr>
											    					<td></td>
											    					<td></td>
												    	...
												    	<table class="table table-striped">
											    			...
											    			<tbody>
											    				<tr ng-repeat="x in ordered track by $index">
											    					...
											    					<td><a style="cursor:pointer;" data-toggle="modal" data-target="#myModal2" ng-click="viewComment(x.Comment)">View Comment</a></td>							    	
											    				</tr>											    				
											    			</tbody>
											    		</table>
												    </div>												    
...
<script type="text/javascript">
    ...
    .then(function (response) {$scope.menus = response.data.records;});	
	    ...
	    $scope.removeItem = function(index,val)
	    {
	    	if(index!==undefined)
	    	{
